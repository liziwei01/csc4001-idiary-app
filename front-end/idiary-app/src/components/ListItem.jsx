      ...
      <div>
        ...
        <div className="commentViewStyle">
          <ul className="ulStyle">
            <li className="liStyle" onClick={this.like}>
              点赞:{this.state.zanNum}
            </li>
            <div className="shuxian"></div>
            <li className="liStyle" onClick={this.comment}>
              评论:{data.NoComment}
            </li>
            {data.isShowComment && <input type="text" />}

            <div className="shuxian"></div>
            <li className="liStyle" onClick={this.transferdata}>
              转发:{data.NoPointGreat}
            </li>
          </ul>
        </div>
      </div>
